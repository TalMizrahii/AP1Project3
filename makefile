...
run-server: server.out
	./server.out ./Server/datasets/iris/iris_classified.csv 12345
	
run-client: client.out
	./client.out 127.0.0.1 12345

run-beans: server.out
	./server.out ./Server/datasets/beans/beans_Classified.csv 12345
	
run-iris: server.out
	./server.out ./Server/datasets/iris/iris_classified.csv 12345

run-wine: server.out
	./server.out ./Server/datasets/wine/wine_Classified.csv 12345
